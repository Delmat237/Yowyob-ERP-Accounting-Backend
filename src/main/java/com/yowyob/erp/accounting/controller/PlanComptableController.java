...
public class PlanComptableController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Compte comptable créé"),
    ...
    public ResponseEntity<ApiResponseWrapper<PlanComptableDto>> getPlanComptable(@PathVariable UUID id) {
...
*/
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Compte comptable mis à jour"),
    ...
    public ResponseEntity<ApiResponseWrapper<PlanComptableDto>> updatePlanComptable(
        ...
        return ResponseEntity.ok(ApiResponseWrapper.success(updated, "Compte comptable mis à jour"));
    }

    @Operation(summary = "Désactiver un compte comptable", description = "Désactive un compte comptable par son identifiant UUID")
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "Compte comptable désactivé"),
            @ApiResponse(responseCode = "404", description = "Compte comptable non trouvé"),
            @ApiResponse(responseCode = "401", description = "Non autorisé"),
            @ApiResponse(responseCode = "403", description = "Accès interdit")
    })
    ...
    public ResponseEntity<ApiResponseWrapper<Void>> deactivatePlanComptable(@PathVariable UUID id) {
        ...
        return ResponseEntity.status(HttpStatus.NO_CONTENT)
                .body(ApiResponseWrapper.success(null, "Compte comptable désactivé"));
    }
}