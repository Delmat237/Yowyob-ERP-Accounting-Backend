...
const mockInvoices: Invoice[] = [
    { id: 'inv1', invoiceNumber: '119MSVM025CE000', client: { id: 'c1', name: 'MOSES', reference: "c1" }, orderDate: new Date(), dueDate: new Date(), status: 'Non payée', items: [{ id: '1', code: 'D160008', name: 'DILLIANT ABRO 4.5L', quantity: 2, unitPrice: 7500, discount: 0, total: 15000 }], payments: [], totalHT: 15000, totalDiscount: 0, totalNetHT: 15000, precompte: 0, totalTVA: 0, totalTTC: 15000, totalPaid: 0, balanceDue: 15000 },
    { id: 'inv2', invoiceNumber: '119MSVM025CE001', client: { id: 'c2', name: 'CLIENT DIVERS', reference: "c2" }, orderDate: new Date(), dueDate: new Date(), status: 'Payée', items: [], payments: [], totalHT: 12000, totalDiscount: 0, totalNetHT: 12000, precompte: 0, totalTVA: 0, totalTTC: 12000, totalPaid: 12000, balanceDue: 0 },
    { id: 'inv3', invoiceNumber: '119MSVM025CE002', client: { id: 'c1', name: 'MOSES', reference: "c1" }, orderDate: new Date(), dueDate: new Date(), status: 'Partiellement payée', items: [], payments: [], totalHT: 1500, totalDiscount: 0, totalNetHT: 1500, precompte: 0, totalTVA: 0, totalTTC: 1500, totalPaid: 500, balanceDue: 1000 },
    ...
    <div className="h-full flex gap-6">
      <div className="w-1/3 xl:w-1/4 h-full flex flex-col gap-4">
        ...
        <Card className="flex-grow flex flex-col min-h-0">
          <CardHeader className="p-4 flex-shrink-0"><CardTitle className="text-base">Factures trouvées</CardTitle></CardHeader>
